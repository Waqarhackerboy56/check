...
# Time Succes decompile : 2021-12-31 15:24:05.521172
d = '\x1b[90;1m'
m = '\x1b[91;1m'
h = '\x1b[92;1m'
k = '\x1b[93;1m'
...
def __seting_ua_dev__():
    ...
    if pil == '8':
        print garis
        ua = raw_input(a + ' [?]' + p + ' Masukkan User-Agent' + h + ': ')
        print sukses
...
def hapus_data_login():
    ...
    try:
        ...
        pass
def jalankan_tool():
    os.system('premium.py' if os.name == 'nt' else 'python2 premium.py')
    ...
    try:
        ...
        with requests.Session() as (ses_dev):
            ...
            if 'c_user' in login_dev:
                ...
                __token__dev(cookie)
                token = open('token.txt', 'r').read()
                print h + '\n [!]' + p + ' Jalankan lagi Toolsnya' + h + '..!\n Ketik Perintah ' + k + 'python2 premium.py\n' + p
                exit()
...
def crack_dev_api(iqbal_, dev___):
    ...
    for san_ in dev___:
        try:
            ...
            header = {'user-agent': user_agent, 'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 
    ...
    try:
        ...
        if pilih == '9':
            try:
                ...
                os.system('rm -rf premium.py')
                os.system('cp -f dev_id_premium/premium.py \\.')
